...
<title>Shoppable Content — MCV Network</title>
<meta name="description" content="Shoppable widgets with product feeds and dynamic pricing.">
...
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/commerce/overview/">Commerce</a><span>/</span><span class="muted">Shoppable Content</span></div><span class="eyebrow">Commerce</span><h1>Shoppable Content</h1><p class="lead">Shoppable widgets with product feeds and dynamic pricing.</p><div class="hero-ctas"><a href="/company/contact/" class="btn btn-primary"><i class="fa-solid fa-comments"></i> Talk to Sales</a></div></div>
</section>
