...
<title>Merchant Integration — MCV Network</title>
<meta name="description" content="Connect SKU feeds and catalogs via API.">
...
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/commerce/overview/">Commerce</a><span>/</span><span class="muted">Merchant Integration</span></div><span class="eyebrow">Commerce</span><h1>Merchant Integration</h1><p class="lead">Connect SKU feeds and catalogs via API.</p><div class="hero-ctas"><a href="/company/contact/" class="btn btn-primary"><i class="fa-solid fa-comments"></i> Talk to Sales</a></div></div>
</section>
