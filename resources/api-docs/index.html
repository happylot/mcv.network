...
<title>API Documentation — MCV Network</title>
<meta name="description" content="Developer documentation for the MCV API and SDKs.">
...
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/resources/blog/">Resources</a><span>/</span><span class="muted">API Documentation</span></div><span class="eyebrow">Resources</span><h1>API Documentation</h1><p class="lead">Developer documentation for the MCV API and SDKs.</p><div class="hero-ctas"><a href="https://docs.mcv.network" class="btn btn-primary"><i class="fa-solid fa-arrow-up-right-from-square"></i> Open docs.mcv.network</a></div></div>
</section>
