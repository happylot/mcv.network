...
<title>Revenue Optimization — MCV Network</title>
<meta name="description" content="Tips and tools to maximize publisher revenue.">
...
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/publishers/">Publishers</a><span>/</span><span class="muted">Revenue Optimization</span></div><span class="eyebrow">Publishers</span><h1>Revenue Optimization <span class="pill amber" style="margin-left:8px">Phase 4</span></h1><p class="lead">Tips and tools to maximize publisher revenue. This page is part of the Phase 4 publisher rollout.</p><div class="hero-ctas"><a href="/publishers/apply/" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i> Join the Waitlist</a></div></div>
</section>
