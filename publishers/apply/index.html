...
<title>Apply to the Network — MCV Network</title>
<meta name="description" content="Join the MCV publisher network — apply today.">
...
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/publishers/">Publishers</a><span>/</span><span class="muted">Apply to the Network</span></div><span class="eyebrow">Publishers</span><h1>Apply to the Network <span class="pill amber" style="margin-left:8px">Phase 4</span></h1><p class="lead">Join the MCV publisher network — apply today. This page is part of the Phase 4 publisher rollout.</p><div class="hero-ctas"><a href="/publishers/apply/" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i> Join the Waitlist</a></div></div>
</section>
