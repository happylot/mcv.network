...
<title>Commerce Media — MCV Network</title>
<meta name="description" content="Shoppable content, dynamic product feeds and affiliate commerce across the open web.">
<link rel="icon" type="image/png" href="/logo_MCV_network.png">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<link rel="stylesheet" href="/assets/css/mcv.css">
</head>
<body data-nav="commerce">
<div id="mcv-nav"></div>
<section class="hero center">
  <div class="hero-inner"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/commerce/overview/">Commerce</a><span>/</span><span class="muted">Overview</span></div><span class="eyebrow">Commerce</span><h1>Shoppable Content That <span class="highlight">Converts</span></h1><p class="lead">Turn editorial and recommendation surfaces into commerce with dynamic, shoppable product cards.</p><div class="hero-ctas"><a href="/company/contact/" class="btn btn-primary"><i class="fa-solid fa-comments"></i> Talk to Sales</a></div></div>
</section>
